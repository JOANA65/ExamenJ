...
* Acceso a documentación vía navegador
  Ejemplo:
...
**📅 Lunes a las 6:00 PM**
**La entrega compartirar el link de su proyecto al siguiente correo ricardo.lugo@utvtol.edu.mx**
...
# 📌 API REST con Flask + Swagger

## 📖 Descripción
Este proyecto consiste en el desarrollo de una API REST utilizando Flask, que representa una estructura académica con:
...
Se utilizó **SQLite** como sistema de base de datos.

### ✔ Justificación
SQLite fue seleccionado debido a que:
- Es la opción recomendada en el enunciado del examen
- No requiere configuración de servidor externo
- Permite una fácil ejecución del proyecto
- Genera una base de datos local (`database.db`)
